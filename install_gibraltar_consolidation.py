...
HOME_ES = r'''<main class="gwc-home" id="contenido">
  ...
  <section class="gwc-status" aria-labelledby="gwc-status-title">
    <header class="gwc-section-head"><div><p class="gwc-kicker">PANEL OPERATIVO</p><h2 id="gwc-status-title">Una lectura rápida, con fecha y confianza</h2></div><p id="gwcStatusMeta">Pendiente de la primera comprobación.</p></header>
    <p class="gwc-confidence-note" id="gwcConfidenceNote">La confianza se explica según la frescura y cobertura de las fuentes consultadas.</p>
  ...
  <section class="gwc-current" aria-labelledby="gwc-current-title">
    <div class="gwc-current-main">
      ...
      <div class="gwc-news-list" id="gwcNewsList"><p class="gwc-empty">No hay novedades prerenderizadas disponibles.</p></div>
    </div>
