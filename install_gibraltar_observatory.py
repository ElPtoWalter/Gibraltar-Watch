...
<section class="gwo-livebar gwo-shell" aria-label="Estado resumido del observatorio">
  <div class="gwo-livebar-inner">
    <div class="gwo-state" data-gwo-state-box><span class="gwo-state-dot" aria-hidden="true"></span><div class="gwo-state-copy"><small>ESTADO DEL ESTRECHO</small><b data-gwo-state>Sin datos todavía</b><small data-gwo-updated>Pendiente de la primera comprobación</small></div></div>
...
<section class="gwo-panel gwo-shell" aria-labelledby="gwo-current-title">
  ...
  <div class="gwo-state-hero">
    <article class="gwo-state-main" data-gwo-state-box><div class="gwo-kicker">NIVEL GENERAL</div><strong data-gwo-state>Sin datos todavía</strong><p data-gwo-summary>La lectura consolidada se publicará con la primera comprobación.</p><p class="gwo-confidence-note" data-gwo-confidence-note>La confianza se explica según la frescura y cobertura de las fuentes consultadas.</p><div class="gwo-meta-row"><span class="gwo-chip">Aviso: <b data-gwo-alert-level>—</b></span><span class="gwo-chip">Confianza: <b data-gwo-confidence>—</b></span><span class="gwo-chip" data-gwo-health-overall>—</span><span class="gwo-chip">Actualizado <b data-gwo-updated>—</b></span></div><div class="gwo-alert-actions"><button class="button" type="button" data-gwo-enable-alerts>Activar alertas en este navegador</button><small data-gwo-alert-status>Solo avisaremos de cambios de nivel mientras este navegador esté abierto.</small></div></article>
...
<section class="gwo-panel gwo-shell"><div class="gwo-panel-head"><div><div class="gwo-kicker">DESDE AYER</div><h2>Qué ha cambiado</h2></div></div><p data-gwo-since-yesterday>Aún no hay una referencia diaria anterior comparable.</p></section>
