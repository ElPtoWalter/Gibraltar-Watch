...
ES_REPLACEMENTS = [
    ...
    ("Generado automáticamente a partir de salidas verificadas de Gibraltar Watch.",
     "Compuesto automáticamente a partir de los datos del monitor; no implica verificación humana individual."),
    ("Generado automáticamente", "Compuesto automáticamente"),
