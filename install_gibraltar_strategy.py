...
def update_llms() -> None:
    ...
    if marker not in text:
        text = text.rstrip() + '\n\n' + marker + '\n' + '\n'.join([
            ...
            '- Current situation: https://estrechogibraltar.com/en-current-situation.html',
        ]) + '\n'
    path.write_text(text, encoding='utf-8')
